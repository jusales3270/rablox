...
> = {
  ...
  cyan: {
    outer: "bg-gradient-to-b from-[#083344] to-[#67e8f9]",
    inner: "bg-gradient-to-b from-[#cffafe] via-[#0b5977] to-[#a5f3fc]",
    button: "bg-gradient-to-b from-[#22d3ee] to-[#0e7490]",
    textColor: "text-white",
    textShadow: "[text-shadow:_0_-1px_0_rgb(14_116_144_/_100%)]",
  },
};
...
export const MetalButton = React.forwardRef<
  HTMLButtonElement,
  MetalButtonProps
// FIX: Refactored component signature to be more explicit, resolving a subtle type inference issue.
>((props, ref) => {
